...
RODOVIAS_DB = {
    "BR-153 (Transbrasiliana)": [(-16.68, -49.25), (-17.73, -49.24), (-18.52, -49.19), (-20.45, -51.39)],
...
def find_local_pois(lat, lon, return_coords=False):
    ...
    query_combinada = f"""[out:json][timeout:45];((node["place"~"city|town|village"](around:{raio_local_m},{lat},{lon}););(node["man_made"="silo"](around:{raio_local_m},{lat},{lon});node["name"~"Silo|Cooperativa|Graneleiro",i](around:{raio_local_m},{lat},{lon});););out center;"""
